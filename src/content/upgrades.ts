...
const UPGRADE_CATALOG: UpgradeDefinition[] = [
  ...
  { id: "prepared-presentation", category: "charisma", title: "Presentazione preparata", description: "Spiegazioni più chiare trasformano incontri in contatti utili.", effectLabel: "+3% prove e contatti per livello", effect: "eventContactsMultiplier", effectPerLevel: 0.03, baseCost: 15, costGrowth: GROWTH, maxLevel: 5, requiredHistoricMembers: 0 },
  { id: "qr-cards", category: "charisma", title: "Biglietti con QR code", description: "Lasciare un indirizzo diventa immediato.", effectLabel: "+4% prove e contatti per livello", effect: "eventContactsMultiplier", effectPerLevel: 0.04, baseCost: 50, costGrowth: GROWTH, maxLevel: 5, requiredHistoricMembers: 5 },
  { id: "coordinated-demo", category: "charisma", title: "Dimostrazione coordinata", description: "Una presentazione ordinata migliora la qualità percepita.", effectLabel: "+5% persone incontrate per livello", effect: "eventAttendanceMultiplier", effectPerLevel: 0.05, baseCost: 100, costGrowth: GROWTH, maxLevel: 5, requiredHistoricMembers: 15 },
  { id: "recognizable-stand", category: "charisma", title: "Stand riconoscibile", description: "Il pubblico capisce subito dove fermarsi.", effectLabel: "+7% persone incontrate per livello", effect: "eventAttendanceMultiplier", effectPerLevel: 0.07, baseCost: 190, costGrowth: GROWTH, maxLevel: 5, requiredHistoricMembers: 25 },
  { id: "order-welcome", category: "charisma", title: "Accoglienza dell'Ordine", description: "La conversazione prosegue naturalmente fino allo scambio dei contatti.", effectLabel: "+4% prove e contatti per livello", effect: "eventContactsMultiplier", effectPerLevel: 0.04, baseCost: 320, costGrowth: GROWTH, maxLevel: 5, requiredHistoricMembers: 40 },
  { id: "difficult-questions", category: "charisma", title: "Risposte alle domande difficili", description: "Anche le domande più specifiche ricevono una risposta utile.", effectLabel: "+5% prove e contatti per livello", effect: "eventContactsMultiplier", effectPerLevel: 0.05, baseCost: 550, costGrowth: GROWTH, maxLevel: 5, requiredHistoricMembers: 60 },
  { id: "not-that-thing", category: "charisma", title: "No, non è esattamente quella cosa", description: "La spiegazione definitiva, sorprendentemente efficace.", effectLabel: "+8% prove e contatti per livello", effect: "eventContactsMultiplier", effectPerLevel: 0.08, baseCost: 950, costGrowth: GROWTH, maxLevel: 5, requiredHistoricMembers: 90 },
  ...
  { id: "demo-set", category: "equipment", title: "Set da dimostrazione", description: "Gli eventi possono accogliere più persone.", effectLabel: "+4% persone agli eventi per livello", effect: "eventAttendanceMultiplier", effectPerLevel: 0.04, baseCost: 620, costGrowth: GROWTH, maxLevel: 5, requiredHistoricMembers: 50 },
